...
const Header = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-4 z-40 flex h-[60px] justify-center">
      <div
        className={cn(
          'bg-secondary mx-6 w-full max-w-[375px] items-center justify-between rounded-3xl border border-border px-4 shadow-sm saturate-100 backdrop-blur-[10px] sm:max-w-screen-sm xl:max-w-screen-xl',
